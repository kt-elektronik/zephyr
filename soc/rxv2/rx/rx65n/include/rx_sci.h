/* Header for the 13 independent serial communications interface (SCI) 
 * channels.
 * struct st_sci0_t for SCIg modules SCI0 to SCI9
 * struct st_sci10_t for SCIi modules SCI10 and SCI11
 * struct st_sci12_t for the SCIh module SCI12
 * The SCIg module (SCI0 to SCI9) and SCIi module (SCI10 and SCI11) can handle
 * both asynchronous and clock synchronous serial communications.*/
