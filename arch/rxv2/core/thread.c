...
void arch_new_thread(struct k_thread *thread, k_thread_stack_t *stack,
	...
	// thread->callee_saved.ra = (uint32_t)z_thread_entry_wrapper; // check if: NIOS2-specfic (see arch/nios2/core/swap.S)
	thread->callee_saved.key = 0x00000001; // check if: correct, replaced NIOS2_STATUS_PIE_MSK from include/arch/nios2/nios2.h:#define NIOS2_STATUS_PIE_MSK  (0x00000001);
