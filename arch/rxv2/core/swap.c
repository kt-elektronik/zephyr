...
/**
 * @file
 * @brief Kernel swapper code for Renesas rxv2 architecture (e.g. RX65N).
 *
 * This module implements the arch_swap() routine for the Renesas rxv2 architecture (e.g. RX65N).
 *
 */
